...
def project_introduction(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('project_introduction.html',data)

def images(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('images.html',data)
...
def project_details(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('project_details.html',data)

def image_details(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('image_details.html',data)

def application(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('application.html',data)
def application_details(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('application_detials.html',data)

def volume(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('volume.html',data)

def volume_details(request):
	data = {'user': {'userName': request.session.get('current_user','')},}
	return render_to_response('volume_details.html',data)
